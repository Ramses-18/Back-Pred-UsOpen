...
public interface MatchRepository extends JpaRepository<Match, Long> {
    List<Match> findByMatchDateOrderByMatchTimeAsc(LocalDate date); // mantener por compat
    ...
    Optional<Match> findByApiEventId(String apiEventId);
    Match findByFollowsMatchId(Long followsMatchId);   // para re-cadenar al borrar

    // Query nativa para obtener el max orderInCourt de una cancha+fecha
